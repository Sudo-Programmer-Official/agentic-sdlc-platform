    ...
    try:
        ...
        await ai_job_manager.record_deterministic_job(
            AIJobRequest(
                ...
                feature_key="knowledge-verification",
                surface="knowledge",
                entrypoint="knowledge.analyze_event",
                ...
                confidence_score=change.confidence_score,
                metadata={"source_type": event.source_type, "knowledge_flow": "verification"},
            ),
        ...
        await ai_job_manager.record_deterministic_job(
            AIJobRequest(
                ...
                repository_id=event.repository_id,
                knowledge_event_id=event.id,
                feature_key="knowledge-proposal",
                surface="knowledge",
                entrypoint="knowledge.analyze_event",
                changed_files=change.impacted_files,
                background_job=event.source_type in {"push", "pr_merged", "agent_run"},
                deterministic_preferred=True,
                confidence_score=change.confidence_score,
                metadata={"proposal_count": proposal_count, "source_type": event.source_type, "knowledge_flow": "proposal"},
            ),
