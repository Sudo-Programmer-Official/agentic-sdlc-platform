    ...
    async def generate(self, system_prompt: str, user_prompt: str) -> tuple[str, dict]:
        ...
        for delay in backoff:
            try:
                ...
                usage = {
                    "input_tokens": getattr(resp, "input_tokens", None) or getattr(getattr(resp, "usage", None) or {}, "input_tokens", None),
                    "output_tokens": getattr(resp, "output_tokens", None) or getattr(getattr(resp, "usage", None) or {}, "output_tokens", None),
                }
